        ...
        <div class="mt-6 pt-4 border-t border-outline-variant">
          <div class="bg-green-50 border border-green-200 rounded-xl p-4">
            <div class="flex items-start gap-3">
              ...
              <div class="flex-1">
                <h4 class="font-semibold text-sm text-green-900">¿Encontraste algún error en tus datos?</h4>
                <p class="text-xs text-green-700 mt-0.5">Contáctanos por WhatsApp al <strong>+51 992 809 049</strong> para corregirlo.</p>
                <a href="https://wa.me/51992809049?text=Hola%2C%20soy%20${encodeURIComponent(studentProfile.nombres || '')}%20con%20DNI%20${encodeURIComponent(studentProfile.dni || '')}%20y%20he%20detectado%20un%20error%20en%20los%20datos%20de%20mi%20perfil.%20%C2%BFMe%20podr%C3%ADan%20ayudar%20a%20corregirlo%3F" target="_blank" class="inline-flex items-center gap-1.5 mt-2 px-3 py-1.5 bg-green-600 hover:bg-green-700 text-white text-xs font-semibold rounded-lg transition-colors">
