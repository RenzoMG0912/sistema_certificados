// Archivo: src/middlewares/studentAuth.middleware.js
...
/**
 * Middleware para validar el token JWT estudiantil y proteger rutas privadas del estudiante
 */
module.exports = (req, res, next) => {
  ...
  try {
    ...
    console.error('Error al verificar JWT estudiantil:', error.message);
